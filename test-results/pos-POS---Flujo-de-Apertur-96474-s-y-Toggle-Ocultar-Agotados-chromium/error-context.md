...
- Name: pos.spec.ts >> POS - Flujo de Apertura, Venta y Cierre (FASE 6) >> FASE 5: Optimizaciones UX/UI >> 5.3 y 5.4 Semáforos y Toggle Ocultar Agotados
- Location: tests\e2e\pos.spec.ts:308:5
...
Locator: locator('[data-testid="product-grid"]').locator('[data-testid="stock-badge-red"]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="product-grid"]').locator('[data-testid="stock-badge-red"]').first()
