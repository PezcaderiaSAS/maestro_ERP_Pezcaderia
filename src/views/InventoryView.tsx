...
import { RefreshCw, Package, ArrowRight, ShieldAlert, CheckCircle } from 'lucide-react';
...
export default function InventoryView({ products, stock, setStock }: InventoryViewProps) {
  ...
  return (
    <div className="hr-layout animate-fade-in" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', height: '100%', overflowY: 'auto' }}>
